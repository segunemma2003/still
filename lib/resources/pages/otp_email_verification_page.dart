...
class OtpEmailVerificationPage extends NyStatefulWidget {
  static RouteView path =
      ("/otp-email-verification", (_) => OtpEmailVerificationPage());

  OtpEmailVerificationPage({super.key})
      : super(child: () => _OtpEmailVerificationPageState());
}

class _OtpEmailVerificationPageState extends NyPage<OtpEmailVerificationPage> {
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(12),
                          child: Image.asset(
                            'verify.png', // Using the same verify image
                            width: 64,
                            height: 64,
                            fit: BoxFit.cover,
                          ).localAsset(),
                    ...
                    Text(
                      'We just sent you an email verification code to\n$email',
