...
class SignUpMobilePage extends NyStatefulWidget {
  static RouteView path = ("/sign-up-mobile", (_) => SignUpMobilePage());

  SignUpMobilePage({super.key}) : super(child: () => _SignUpMobilePageState());
}

class _SignUpMobilePageState extends NyPage<SignUpMobilePage> {
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(12),
                          child: Image.asset(
                            'signupmobile.png', // You can change this to your desired image
                            width: 64,
                            height: 64,
                            fit: BoxFit.cover,
                          ).localAsset(),
                    ...
                    // Email Button - Updated to match sign-in styling
                    Container(
                      height: 48,
                      child: Container(
                        margin: const EdgeInsets.all(1), // Border width
  ...
  bool _isValidPhoneNumber(String phoneNumber) {
    // Basic phone number validation - adjust regex according to your requirements
